...
/* harmony export */   hydrationDataAll: () => (/* binding */ hydrationDataAll),
/* harmony export */   waterChartToDom: () => (/* binding */ waterChartToDom)
/* harmony export */ });
/* harmony import */ var _data_model_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _charts_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8);
/* harmony import */ var _apiCalls_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9);
/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
...
window.addEventListener('DOMContentLoaded', function () {
  Promise.all(_apiCalls_js__WEBPACK_IMPORTED_MODULE_3__.fetchPromises).then((values) => {
    //data from Web APIs:
    ...
    const randomUserIndex = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getRandomUser)(userDataAll);
    currentUser = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getUserData)(userDataAll, randomUserIndex);

    //Hydration functions:
    hydrationData = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.filterUserData)(hydrationDataAll, currentUser);  
    const todaysHydrationDate = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getLatestData)(hydrationData);
    const waterPerDayPerWeek = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getLatestData)(hydrationData, 'week');
    waterChartToDom = (0,_charts_js__WEBPACK_IMPORTED_MODULE_1__.waterChart)(waterPerDayPerWeek);
    
    //Sleep functions:
    const sleepData = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.filterUserData)(sleepDataAll, currentUser);
    const averageSleep = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.universalAverage)(sleepData, 'hoursSlept');
    const aveSleepQuality = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.universalAverage)(sleepData, 'sleepQuality');
    const sleepPerDayPerWeek = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getLatestData)(sleepData, 'week');
    const sleepToday = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getLatestData)(sleepData);
    const sleepChartToDom = (0,_charts_js__WEBPACK_IMPORTED_MODULE_1__.sleepingChart)(sleepPerDayPerWeek);
    
    //Activity and Step functions:
    const averageSteps = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.universalAverage)(userDataAll, 'dailyStepGoal');
    const activityData = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.filterUserData)(activityDataAll, currentUser);
    const activityPerDayPerWeek = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getLatestData)(activityData,'week');
    const activityToday = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getLatestData)(activityData);
    const milesPerDay = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getInfoPerDay)(currentUser, activityData, activityToday, "numSteps");
    const stepGoal = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getStepGoal)(currentUser, activityData, activityToday);
    const minutesPerDay = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.getInfoPerDay)(currentUser, activityData, activityToday, "minutesActive"); 
    const stepChartToDom = (0,_charts_js__WEBPACK_IMPORTED_MODULE_1__.stepChart)(activityPerDayPerWeek);
    const activityChartToDom = (0,_charts_js__WEBPACK_IMPORTED_MODULE_1__.activityChart)(activityPerDayPerWeek);
    const compareSteps = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.compareStepGoal)(currentUser, userDataAll);

    //Dom Updates functions:
    (0,_domUpdates_js__WEBPACK_IMPORTED_MODULE_2__.displayUserInfo)(currentUser, activityToday);
    (0,_domUpdates_js__WEBPACK_IMPORTED_MODULE_2__.displayWaterInfo)(todaysHydrationDate, waterChartToDom);
    (0,_domUpdates_js__WEBPACK_IMPORTED_MODULE_2__.displaySleepInfo)(averageSleep, aveSleepQuality, sleepToday, sleepChartToDom);
    (0,_domUpdates_js__WEBPACK_IMPORTED_MODULE_2__.displayActivityInfo)(milesPerDay, minutesPerDay, activityToday, activityChartToDom);
    (0,_domUpdates_js__WEBPACK_IMPORTED_MODULE_2__.displayStepInfo)(currentUser, stepGoal, stepChartToDom, compareSteps, averageSteps);
    }); 

    //Dragging elements:
    (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.setupDraggable)(stepBox);
    (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.setupDraggable)(activityBox);
    (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.setupDraggable)(waterBox);
    (0,_data_model_js__WEBPACK_IMPORTED_MODULE_0__.setupDraggable)(sleepBox);
});
...
addButton.addEventListener('click', function(event) {
  ...
  ;(0,_apiCalls_js__WEBPACK_IMPORTED_MODULE_3__.sendDataToAPI)(currentUser)
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   compareStepGoal: () => (/* binding */ compareStepGoal),
/* harmony export */   dragMoveListener: () => (/* binding */ dragMoveListener),
/* harmony export */   filterUserData: () => (/* binding */ filterUserData),
/* harmony export */   getInfoPerDay: () => (/* binding */ getInfoPerDay),
/* harmony export */   getLatestData: () => (/* binding */ getLatestData),
/* harmony export */   getOuncesPerDay: () => (/* binding */ getOuncesPerDay),
/* harmony export */   getRandomUser: () => (/* binding */ getRandomUser),
/* harmony export */   getStepGoal: () => (/* binding */ getStepGoal),
/* harmony export */   getUserData: () => (/* binding */ getUserData),
/* harmony export */   setupDraggable: () => (/* binding */ setupDraggable),
/* harmony export */   specificSleepDay: () => (/* binding */ specificSleepDay),
/* harmony export */   universalAverage: () => (/* binding */ universalAverage)
/* harmony export */ });
/* harmony import */ var interactjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
...
/// === HELPER FUNCTIONS === ///
const getRandomUser = userDataObj => {
  const currentUserIndex = Math.floor(Math.random() * userDataObj.length);
  return currentUserIndex;
};

const getUserData = (userObj, indexPosition) => {
...
const universalAverage = (obj, accessKey) => {
  if (obj.length === 0) {
    return 0; 
  }
...
const getLatestData = (filteredData, wholeWeek) => {
  let total;
  if (wholeWeek === 'week') {
...
const filterUserData = (data, currentUserObject) => {
...
const specificSleepDay = (filterUser, dateOfSleep) => {
...
const getInfoPerDay = (currentUser, currentData, today, specific) => {
...
const getStepGoal = (currentUser, currentActivityData, today) => {
...
const compareStepGoal = (currentUser, allUsers) => {
...
const getOuncesPerDay = (userObj, dataList, date) => {
...
//drag function
function setupDraggable(targetElement) {
interactjs__WEBPACK_IMPORTED_MODULE_0___default()(targetElement) 
  .draggable({
    inertia: true,
    modifiers: [
      interactjs__WEBPACK_IMPORTED_MODULE_0___default().modifiers.restrictRect({
  ...
  .resizable({
    ...
    modifiers: [
      interactjs__WEBPACK_IMPORTED_MODULE_0___default().modifiers.restrictEdges({
        outer: 'parent'
      }),
      interactjs__WEBPACK_IMPORTED_MODULE_0___default().modifiers.restrictSize({
...
/* harmony export */   sleepingChart: () => (/* binding */ sleepingChart),
/* harmony export */   stepChart: () => (/* binding */ stepChart),
/* harmony export */   waterChart: () => (/* binding */ waterChart)
/* harmony export */ });
/* harmony import */ var chart_js_auto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);


/// === CHARTS === ///
const waterChart = (waterPerDayPerWeek) => {
  const data = waterPerDayPerWeek;
  var waterC = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById("waterChart"), {
    type: "bar",
    data: {
...
const stepChart = (activityData) => {
  const data = activityData;
  new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById("stepChart"), {
    type: "doughnut",
    data: {
      labels: data.map((row) => row.date),
      datasets: [
...
const activityChart = (activityData) => {
  const data = activityData;
  new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById("activityChart"), {
    type: "line",
    data: {
      labels: data.map((row) => row.date),
      datasets: [
...
const sleepingChart = (sleepInfo) => {
  const data = sleepInfo;
  new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById("sleepChart"), {
    type: "bar",
    data: {
      labels: data.map((row) => row.date),
      datasets: [
...
/* harmony export */ });
/* harmony import */ var _dist_chart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
...
/* harmony export */ });
/* harmony import */ var _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
/*!
 * Chart.js v4.4.0
...
/* harmony export */ });
/* harmony import */ var _kurkle_color__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
/*!
 * Chart.js v4.4.0
 * https://www.chartjs.org
 * (c) 2023 Chart.js Contributors
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   displayActivityInfo: () => (/* binding */ displayActivityInfo),
/* harmony export */   displaySleepInfo: () => (/* binding */ displaySleepInfo),
/* harmony export */   displayStepInfo: () => (/* binding */ displayStepInfo),
/* harmony export */   displayUserInfo: () => (/* binding */ displayUserInfo),
/* harmony export */   displayWaterInfo: () => (/* binding */ displayWaterInfo)
/* harmony export */ });
...
//User Info:
const displayUserInfo = (currentUser, activityToday) => {
...
// Water info:
const displayWaterInfo = (todaysHydrationDate, waterChartToDom) => {
...
//Sleep info:
const displaySleepInfo = (averageSleep, aveSleepQuality, sleepToday, sleepChartToDom) => {
...
//Activity info:
const displayActivityInfo = (milesPerDay, minutesPerDay, activityToday, activityChartToDom) => {
...
//Step:
const displayStepInfo = (currentUser, stepGoal, stepChartToDom, compareSteps, averageSteps) => {
...
/* harmony export */   sendDataToAPI: () => (/* binding */ sendDataToAPI),
/* harmony export */   urls: () => (/* binding */ urls)
/* harmony export */ });
/* harmony import */ var _scripts_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _charts_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8);
/* harmony import */ var _data_model_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1);
...
const fetchPosts = (data) => {
  ...
  .then (json => {
    _scripts_js__WEBPACK_IMPORTED_MODULE_0__.hydrationDataAll.push(json);
    console.log(_scripts_js__WEBPACK_IMPORTED_MODULE_0__.hydrationDataAll, 'inside POST func')
    let newHydrationData = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_3__.filterUserData)(_scripts_js__WEBPACK_IMPORTED_MODULE_0__.hydrationDataAll, _scripts_js__WEBPACK_IMPORTED_MODULE_0__.currentUser); 
    let todaysHydrationDate = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_3__.getLatestData)(newHydrationData);
    console.log(todaysHydrationDate, 'should be newly added')
    let waterPerDayPerWeek = (0,_data_model_js__WEBPACK_IMPORTED_MODULE_3__.getLatestData)(newHydrationData, 'week');
    console.log(waterPerDayPerWeek, 'should included 7 days');
    _scripts_js__WEBPACK_IMPORTED_MODULE_0__.waterChartToDom.destroy(); //bc we imported from another file, we can't set that...
    let newWaterChartToDom = (0,_charts_js__WEBPACK_IMPORTED_MODULE_1__.waterChart)(waterPerDayPerWeek);
    (0,_domUpdates_js__WEBPACK_IMPORTED_MODULE_2__.displayWaterInfo)(todaysHydrationDate, newWaterChartToDom);
  })
  .catch (error => {
    alert(error.message)
  })
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_styles_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nbody {\n  display: flex;\n  flex-direction: row;\n  color: #2A2B2C;\n  font-family: \"Gill Sans\", sans-serif;\n}\n\n.main-row {\n  width: 600px;\n  height: 800px;\n}\n\nheader {\n  color: black;\n  text-align: center;\n  margin: none;\n  padding: none;\n}\n\n/* The two sections of the page */\n#leftMainRow {\n  width: 80%;\n  height: 100vh;\n  background-color: #dee4f1;\n  white-space: nowrap;\n  overflow: scroll;\n}\n\n#rightMainRow {\n  display: flex;\n  flex-direction: column;\n  width: 20%;\n  height: 100vh;\n  background-color: #404348;\n  padding: 10px;\n  margin: none;\n}\n\n/* h1's for sizing */\n.titles {\n  font-size: 30px;\n  font-weight: bold;\n}\n\n.left-section {\n  display: flex;\n  background-color: #dee4f1;\n  align-items: center;\n  justify-content: center;\n  margin-top: 30px;\n}\n\n/* Displayed in top right of webpage */\n#username {\n  display: flex;\n  justify-content: center;\n  color: white;\n  margin: 20px;\n  max-width: 100%;\n}\n\n.first-row-left {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  border-radius: 10px;\n}\n\n.second-row-left {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  border-radius: 10px;\n}\n\n.first-row-left,\n.second-row-left {\n  width: 50%;\n  height: 50%;\n  margin: 30px;\n}\n\n.toggleButton, #addButton {\n  margin: 20px;\n  background-color: #054FB9;\n  color: white;\n  font-family: \"Gill Sans\", sans-serif;\n  font-size: 20px;\n  border: none;\n  padding: 10px;\n  cursor: pointer;\n  outline: none;\n  border-radius: 10px;\n  max-width: 80%;\n  max-height: 100%;\n}\n\n.user-info,\n.arrow {\n  text-align: center;\n}\n\n.user-info {\n  word-wrap: break-word;\n  max-height: 700px;\n}\n\n/* Not sure if this is supposed to be kept */\n/* Add Hydration input boxes */\n.form {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin: 10px;\n}\n\n/* Not sure if this is supposed to be kept */\n.labels {\n  color: #FFFFFF;\n}\n\ninput {\n  border-radius: 10px;\n  width: 180px;\n  height: 50px;\n}\n\n/* Containers and the data and charts they hold */\n#stepsBox {\n  background-color: #8babf1;\n  color: #01285e;\n  box-shadow: 0px 0px 1px 1px #01285e;\n  text-align: center;\n}\n\n#waterBox {\n  background-color: #054FB9;\n  color: white;\n  box-shadow: 0px 0px 1.5px 2px white;\n  text-align: center;\n  padding: 20px;\n}\n\n#activityBox {\n  background-color: #0461cf;\n  color: white;\n  box-shadow: 0px 0px 1.5px 2px white;\n  padding: 20px;\n}\n\n#sleepBox {\n  background-color: #B3C7F7;\n  color: #01285e;\n  padding: 10px;\n  box-shadow: 0px 0px 1px 1px #01285e;\n}\n\n#stepsBox,\n#waterBox,\n#activityBox,\n#sleepBox {\n  white-space: nowrap;\n  overflow-wrap: break-word;\n  width: 650px;\n  height: 400px;\n}\n\n#waterChart,\n#activityChart,\n#sleepChart,\n#stepChart {\n  margin: 20px;\n  top: 130px;\n  max-width: 80%;\n  max-height: 60%;\n  background-color: white;\n  color: black;\n}\n\n/* Keeps text in box when growing or shrinking */\n.steps-text,\n#waterConsumedToday,\n#stepsMadePerDay,\n#minutesActivePerDay,\n#milesWalkedPerDay,\n#weekStepCount,\n#averageSleepOverall,\n#sleepSpecificDay,\n#sleepPerDayPerWeek {\n  white-space: normal;\n}\n\n.error {\n  display: flex;\n  background-color: #054FB9;\n  border-radius: 10px;\n  color: #FFFFFF;\n  text-align: center;\n  box-shadow: 4px 4px 4px 4px #01285e;\n}\n\n.error-message {\n  display: flex;\n  flex-direction: row;\n  font-size: xxx-large;\n  font-weight: lighter;\n  color: red;\n  font-style: italic;\n  margin: 20% 20%;\n}\n\n.sr-only {\n  position: absolute;\n  width: 1px;\n  height: 1px;\n  padding: 0;\n  overflow: hidden;\n  clip: rect(0, 0, 0, 0);\n  white-space: nowrap;\n  border: 0;\n}\n\n.hidden {\n  display: none;\n}", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,SAAA;EACA,UAAA;EACA,sBAAA;AACF;;AAEA;EACE,aAAA;EACA,mBAAA;EACA,cAAA;EACA,oCAAA;AACF;;AAEA;EACE,YAAA;EACA,aAAA;AACF;;AAEA;EACE,YAAA;EACA,kBAAA;EACA,YAAA;EACA,aAAA;AACF;;AAEA,iCAAA;AACA;EACE,UAAA;EACA,aAAA;EACA,yBAAA;EACA,mBAAA;EACA,gBAAA;AACF;;AAEA;EACE,aAAA;EACA,sBAAA;EACA,UAAA;EACA,aAAA;EACA,yBAAA;EACA,aAAA;EACA,YAAA;AACF;;AAEA,oBAAA;AACA;EACE,eAAA;EACA,iBAAA;AACF;;AAEA;EACE,aAAA;EACA,yBAAA;EACA,mBAAA;EACA,uBAAA;EACA,gBAAA;AACF;;AAEA,sCAAA;AACA;EACE,aAAA;EACA,uBAAA;EACA,YAAA;EACA,YAAA;EACA,eAAA;AACF;;AAEA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,mBAAA;AACF;;AAEA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,kBAAA;EACA,mBAAA;AACF;;AAEA;;EAEE,UAAA;EACA,WAAA;EACA,YAAA;AACF;;AAEA;EACE,YAAA;EACA,yBAAA;EACA,YAAA;EACA,oCAAA;EACA,eAAA;EACA,YAAA;EACA,aAAA;EACA,eAAA;EACA,aAAA;EACA,mBAAA;EACA,cAAA;EACA,gBAAA;AACF;;AAEA;;EAEE,kBAAA;AACF;;AAEA;EACE,qBAAA;EACA,iBAAA;AACF;;AAEA,4CAAA;AACA,8BAAA;AACA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,YAAA;AACF;;AAEA,4CAAA;AACA;EACE,cAAA;AACF;;AAEA;EACE,mBAAA;EACA,YAAA;EACA,YAAA;AACF;;AACA,iDAAA;AACA;EACE,yBAAA;EACA,cAAA;EACA,mCAAA;EACA,kBAAA;AAEF;;AACA;EACE,yBAAA;EACA,YAAA;EACA,mCAAA;EACA,kBAAA;EACA,aAAA;AAEF;;AACA;EACE,yBAAA;EACA,YAAA;EACA,mCAAA;EACA,aAAA;AAEF;;AACA;EACE,yBAAA;EACA,cAAA;EACA,aAAA;EACA,mCAAA;AAEF;;AACA;;;;EAIE,mBAAA;EACA,yBAAA;EACA,YAAA;EACA,aAAA;AAEF;;AACA;;;;EAIE,YAAA;EACA,UAAA;EACA,cAAA;EACA,eAAA;EACA,uBAAA;EACA,YAAA;AAEF;;AACA,gDAAA;AACA;;;;;;;;;EASE,mBAAA;AAEF;;AACA;EACE,aAAA;EACA,yBAAA;EACA,mBAAA;EACA,cAAA;EACA,kBAAA;EACA,mCAAA;AAEF;;AACA;EACE,aAAA;EACA,mBAAA;EACA,oBAAA;EACA,oBAAA;EACA,UAAA;EACA,kBAAA;EACA,eAAA;AAEF;;AACA;EACE,kBAAA;EACA,UAAA;EACA,WAAA;EACA,UAAA;EACA,gBAAA;EACA,sBAAA;EACA,mBAAA;EACA,SAAA;AAEF;;AACA;EACE,aAAA;AAEF","sourcesContent":["* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nbody {\n  display: flex;\n  flex-direction: row;\n  color: #2A2B2C;\n  font-family: \"Gill Sans\", sans-serif;\n}\n\n.main-row {\n  width: 600px;\n  height: 800px;\n}\n\nheader {\n  color: black;\n  text-align: center;\n  margin: none;\n  padding: none;\n}\n\n/* The two sections of the page */\n#leftMainRow {\n  width: 80%;\n  height: 100vh;\n  background-color: #dee4f1;\n  white-space: nowrap;\n  overflow: scroll;\n}\n\n#rightMainRow {\n  display: flex;\n  flex-direction: column;\n  width: 20%;\n  height: 100vh;\n  background-color: #404348;\n  padding: 10px;\n  margin: none;\n}\n\n/* h1's for sizing */\n.titles {\n  font-size: 30px;\n  font-weight: bold;\n}\n\n.left-section {\n  display: flex;\n  background-color: #dee4f1;\n  align-items: center;\n  justify-content: center;\n  margin-top: 30px;\n}\n\n/* Displayed in top right of webpage */\n#username {\n  display: flex;\n  justify-content: center;\n  color: white;\n  margin: 20px;\n  max-width: 100%;\n}\n\n.first-row-left {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  border-radius: 10px;\n}\n\n.second-row-left {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  border-radius: 10px;\n}\n\n.first-row-left,\n.second-row-left {\n  width: 50%;\n  height: 50%;\n  margin: 30px;\n}\n\n.toggleButton, #addButton {\n  margin: 20px;\n  background-color: #054FB9;\n  color: white;\n  font-family: \"Gill Sans\", sans-serif;\n  font-size: 20px;\n  border: none;\n  padding: 10px;\n  cursor: pointer;\n  outline: none;\n  border-radius: 10px;\n  max-width: 80%;\n  max-height: 100%;\n}\n\n.user-info,\n.arrow {\n  text-align: center;\n}\n\n.user-info {\n  word-wrap: break-word;\n  max-height: 700px;\n}\n\n/* Not sure if this is supposed to be kept */\n/* Add Hydration input boxes */\n.form {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin: 10px;  \n}\n\n/* Not sure if this is supposed to be kept */\n.labels {\n  color: #FFFFFF;\n}\n\ninput {\n  border-radius: 10px;\n  width: 180px;\n  height: 50px;\n}\n/* Containers and the data and charts they hold */\n#stepsBox {\n  background-color: #8babf1;\n  color: #01285e;\n  box-shadow: 0px 0px 1px 1px #01285e;\n  text-align: center;\n}\n\n#waterBox {\n  background-color: #054FB9;\n  color: white;\n  box-shadow: 0px 0px 1.5px 2px white;\n  text-align: center;\n  padding: 20px;\n}\n\n#activityBox {\n  background-color: #0461cf;\n  color: white;\n  box-shadow: 0px 0px 1.5px 2px white;\n  padding: 20px;\n}\n\n#sleepBox {\n  background-color: #B3C7F7;\n  color: #01285e;\n  padding: 10px;\n  box-shadow: 0px 0px 1px 1px #01285e;\n}\n\n#stepsBox,\n#waterBox,\n#activityBox,\n#sleepBox {\n  white-space: nowrap;\n  overflow-wrap: break-word;\n  width: 650px;\n  height: 400px;\n}\n\n#waterChart,\n#activityChart,\n#sleepChart,\n#stepChart {\n  margin:20px;\n  top: 130px;\n  max-width: 80%;\n  max-height: 60%;\n  background-color: white;\n  color: black;\n}\n\n/* Keeps text in box when growing or shrinking */\n.steps-text,\n#waterConsumedToday,\n#stepsMadePerDay,\n#minutesActivePerDay,\n#milesWalkedPerDay,\n#weekStepCount,\n#averageSleepOverall,\n#sleepSpecificDay,\n#sleepPerDayPerWeek {\n  white-space: normal;\n}\n\n.error {\n  display: flex;\n  background-color: #054FB9;\n  border-radius: 10px;\n  color: #FFFFFF;\n  text-align: center;\n  box-shadow: 4px 4px 4px 4px #01285e; \n}\n\n.error-message {\n  display: flex;\n  flex-direction: row;\n  font-size: xxx-large;\n  font-weight: lighter;\n  color: red;\n  font-style: italic;\n  margin: 20% 20%;\n}\n\n.sr-only {\n  position: absolute;\n  width: 1px;\n  height: 1px;\n  padding: 0;\n  overflow: hidden;\n  clip: rect(0, 0, 0, 0);\n  white-space: nowrap;\n  border: 0;\n}\n\n.hidden {\n  display: none;\n}"],"sourceRoot":""}]);
// Exports
